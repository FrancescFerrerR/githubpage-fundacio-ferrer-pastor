...
function print_error($reason,$type = 0) {
   ...
   build_body($title, $bgcolor, $text_color, $link_color, $vlink_color, $alink_color, $style_sheet);
      ...
      ?>
      <body bgcolor='#94B6C6'>
      <p align='center'><font face='Arial' color='#990000' size='2'>El correu no a estat enviat per les següents causes...</font></p><br>
<p align='center'><font face='Arial' size='2' color='#990000'>
     ...
     <p align='center'><font face='Arial' size='2' color='#990000'>Actualitze el seu navegador.</font></p><?
      ...
      ?>
      El correu no a estat enviat per les següents causes...<p align='center'>
      <?
   }
   echo "<br><br>\n";
...
for ($i=0;$i<count($contenitore_finale);$i++) {
   ...
   if (!eregi("^[_\\.0-9a-z-]+@([0-9a-z][0-9a-z-]+\\.)+[a-z]{2,3}$", $contenitore_to_test)) {
      print_error("<b>Aquesta adreça electrònica no és correcta  ($contenitore_to_test) </b>");
   }
}
...
if (($email) || ($EMAIL)) {
   ...
   if (!eregi("^[_\.0-9a-z-]+@([0-9a-z][0-9a-z-]+\.)+[a-z]{2,3}$", $email)) {
      print_error("El seu <b>correu electònic</b> no és correcte");
   }
   $EMAIL = $email;
}
...
<p align='center'><font face='Arial' size='2' color='#800000'>GRACIAS POR HABER CONTACTADO.</font></p><p align='center'><font face='Arial' size='2' color='#800000'>Recibirá la contestación al correo indicado $email<br><br>...Retorno automático a la página en curso....</font></p><meta http-equiv='refresh' content='$delay; url=$url'>
